...
st.set_page_config(page_title="HKUMed Tutor Bot", page_icon="🩺")
st.title(" 🩺 HKUMed Tutor Bot")
...
os.environ['OPENAI_API_KEY'] = openai_api_key  # Set the environment variable programmatically
...
lesson_guides = {
    "Lesson 1: Breast CA": {
        ...
        "description": "This lesson provides information on Breast CA"
    },
    "Lesson 2: Prostate CA": {
       "file": "lc_guides/memory_guide.txt",
       "description": "This lesson is about prostate CA"
    }
}
...
if prompt := st.chat_input():
    ...
    with st.chat_message("assistant"):
        ...
        model = ChatOpenAI(streaming=True, callbacks=[stream_handler], model="gpt-3.5-turbo-16k")  # Removed api_key argument
