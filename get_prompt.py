...
def load_prompt(content):
	...
	template = """You are an expert medical educator, and are responsible for walking the user \
...
Please limit any responses to only one concept or step at a time. \
	...
	Now remember short response for each message.""".format(content=content)
...
def load_prompt_with_questions(content):
	...
	Now remember short response for each message and ask questions\
